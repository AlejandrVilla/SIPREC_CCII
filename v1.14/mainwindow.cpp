...
{
    ui->setupUi(this);
    ui->stackedWidget->addWidget(new Primera_vista(this,_centroSalud));
    ui->stackedWidget->addWidget(new segunda_vista(this,_centroSalud));
    ui->stackedWidget->addWidget(new Tercera_vista(this,_centroSalud));
...
{
    centroSalud->escribirCsvHistoriales();
    centroSalud->escribirCsvMascarilla();
    centroSalud->escribirCsvMedicamento();
    centroSalud->escribirCsvPruebas();
    centroSalud->escribirCsvVacunas();
    delete centroSalud;
    delete ui;
}
